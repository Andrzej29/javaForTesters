...
public class IntegerExamplesTest {
    ...
    public void integerExploration (){
        ...
        assertEquals("intValue returns String", 5, five.intValue());
    ...
    @Test
    public void canConvertHexToString (){
    ...
    @Test
    public void canConfirmMinMaxValue () {
        assertEquals("min value equals -2147483648", -2147483648, Integer.MIN_VALUE);
        assertEquals("max value equals 2147483647", 2147483647, Integer.MAX_VALUE);
    }
}
